...
export const makeEnregistrerLesPseudo = (jeuxRepository: JeuxRepository, joueurRepository: JoueurRepository) => async (session: Session, joueursPseudo: JoueurPseudo[]): Promise<Jeux> => {
